...
void OverlayRenderSystem::OnUpdate()
{
    ...
    DrawText(TextFormat("Cells Drawn %d of %d total cells", WorldPtr->GetRaycaster().GetHitCelList().size(), WorldPtr->GetMap().Cells.size()), 10, GetScreenHeight() - 70, 20, YELLOW);
